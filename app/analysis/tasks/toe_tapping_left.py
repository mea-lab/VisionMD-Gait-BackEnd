...
class ToeTappingLeftTask(BaseTask):
    """
    ...
    def api_response(self, request):
        try:
            # Prepare video parameters from the request.
            ...
            # Extract essential landmarks and complete landmarks from all frames.
        ...
        # Cleanup: release video and remove temporary file.
        if self.video:
            self.video.release()
    ...
    def extract_landmarks(self, detector):
        ...
        Iterates through the specified video frames and extracts:
            ...
            - Left toe landmark (using LEFT_FOOT_INDEX).
        ...
        while current_frame_idx < end_frame_idx:
            ...
            if not detection_result.pose_landmarks:
                ...
                toe_idx = self.LANDMARKS["LEFT_FOOT_INDEX"]
                toe_landmark = [
